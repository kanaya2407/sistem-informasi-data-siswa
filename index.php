		...
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item <?php echo ($page == 'jurusan' || $page == 'tambah-jurusan' || $page == 'edit-jurusan' ? 'active' : '') ?>">
					...
					<ul class="navbar-nav navbar-align">
						<li class="nav-item dropdown">
							...
							<a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
								<img src="foto/<?php echo $_SESSION['user']['foto'] ?>" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark"><?php echo $_SESSION['user']['nama'] ?></span>
							</a>
